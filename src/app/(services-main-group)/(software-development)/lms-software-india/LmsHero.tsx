...
const PILL_LINKS = [
  ...
  { href: "#use-cases", label: "Use Cases", Icon: GraduationCap },
...
function LmsDashboardVisual() {
  return (
    ...
    >
      <defs>
        <linearGradient id="lmsHeroCard" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#3DBC9C" stopOpacity="0.22" />
          <stop offset="100%" stopColor="#36aaf1" stopOpacity="0.14" />
        </linearGradient>
      </defs>
      <rect x="8" y="24" width="320" height="280" rx="18" fill="url(#lmsHeroCard)" />
      <rect
        x="28"
        y="46"
        width="278"
        ...
        strokeWidth="2"
      />
      <rect x="28" y="46" width="278" height="36" rx="12" fill="#3DBC9C" fillOpacity="0.14" />
      <text x="44" y="70" fill="currentColor" fillOpacity="0.85" fontSize="12" fontWeight="bold">
        LMS Admin
      </text>
      <rect x="44" y="98" width="120" height="10" rx="5" fill="currentColor" fillOpacity="0.12" />
      <rect x="44" y="116" width="180" height="8" rx="4" fill="currentColor" fillOpacity="0.08" />
      <text x="44" y="148" fill="currentColor" fillOpacity="0.65" fontSize="9">
        Course completion
      </text>
      <rect x="44" y="156" width="200" height="8" rx="4" fill="currentColor" fillOpacity="0.1" />
      <rect x="44" y="156" width="170" height="8" rx="4" fill="#3DBC9C" fillOpacity="0.55" />
      <text x="44" y="186" fill="currentColor" fillOpacity="0.65" fontSize="9">
        Enrolled learners
      </text>
      <text x="46" y="212" fill="currentColor" fillOpacity="0.9" fontSize="26" fontWeight="bold">
        842
      </text>
      <rect x="44" y="224" width="120" height="10" rx="5" fill="currentColor" fillOpacity="0.08" />
      <text x="44" y="254" fill="currentColor" fillOpacity="0.65" fontSize="9">
        Latest assessment avg.
      </text>
      <rect x="44" y="262" width="140" height="28" rx="8" fill="#36aaf1" fillOpacity="0.22" stroke="currentColor" strokeOpacity="0.2" />
      <text x="56" y="281" fill="currentColor" fillOpacity="0.95" fontSize="14" fontWeight="bold">
        92 / 100
      </text>
      <rect
        x="248"
        ...
        strokeOpacity="0.3"
      />
      <rect x="260" y="136" width="114" height="18" rx="6" fill="white" fillOpacity="0.1" />
      <rect x="268" y="166" width="98" height="52" rx="8" fill="#3DBC9C" fillOpacity="0.35" />
      <rect x="276" y="176" width="82" height="6" rx="3" fill="white" fillOpacity="0.4" />
      <rect x="276" y="188" width="62" height="6" rx="3" fill="white" fillOpacity="0.25" />
      <rect x="268" y="232" width="98" height="12" rx="4" fill="white" fillOpacity="0.12" />
      <rect x="268" y="250" width="72" height="12" rx="4" fill="white" fillOpacity="0.1" />
      <rect x="268" y="268" width="88" height="12" rx="4" fill="white" fillOpacity="0.1" />
      <circle cx="317" cy="302" r="14" fill="#3DBC9C" fillOpacity="0.8" />
    </svg>
  );
}
  ...
  return (
    <>
      <div className="absolute top-4 right-0 md:right-4 z-2 max-w-[200px] rounded-2xl border border-white/80 bg-white/95 dark:bg-[#161B22]/95 dark:border-gray-600/80 px-4 py-3 shadow-lg transition-transform duration-300 motion-safe:hover:-translate-y-1 motion-reduce:hover:translate-y-0">
        ...
        <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-1">Learning management suite</p>
      </div>
      <div className="absolute bottom-8 left-0 md:left-2 z-2 max-w-[220px] rounded-2xl border border-gray-100 bg-white/95 dark:bg-[#161B22]/95 dark:border-gray-600/80 px-4 py-3 shadow-lg transition-transform duration-300 motion-safe:hover:-translate-y-1 motion-reduce:hover:translate-y-0">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-gray-900 dark:text-gray-50">85%</span>
          <span className="text-xs text-[#3DBC9C] font-medium">courses on track</span>
        </div>
        <div className="mt-2 h-1.5 rounded-full bg-gray-100 dark:bg-gray-800 overflow-hidden">
          <div className="h-full w-[85%] rounded-full bg-linear-to-r from-[#3DBC9C] to-[#36aaf1]" />
        </div>
      </div>
    </>
  );
...
export function LmsHero({ leadFormUrl, trustedLogos }: LmsHeroProps) {
  return (
    <div className="w-full text-(--text-black) mt-20 md:mt-24">
      <section className="relative overflow-hidden bg-linear-to-b from-[#f0fdf9] via-white to-white dark:from-[#0d1a16] dark:via-[#0B0E11] dark:to-[#0B0E11]">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-4xl xl:text-[44px] font-bold leading-[1.15] tracking-tight text-gray-900 dark:text-gray-50 max-w-xl">
                ...
                <span className="text-gray-900 dark:text-gray-100">
                  for smarter online learning, training, and skill development
                </span>
              </h1>
              <p className="mt-4 text-sm sm:text-base text-gray-500 dark:text-gray-400 max-w-lg">
                <span className="text-gray-700 dark:text-gray-300 font-medium">
                  Courses · Assessments · Progress · Certificates · Reports
                </span>
                <span className="block mt-2 font-normal">
                  Manage courses, learners, assessments, progress tracking, certificates, and training
                  reports from one easy-to-use learning management system.
                </span>
                <span className="block mt-3 font-normal">
                  RankRaze LMS helps schools, training institutes, businesses, and corporate teams deliver
                  online learning with better control, visibility, and learner engagement.
                </span>
              </p>
              <ul className="mt-5 flex flex-wrap justify-center lg:justify-start gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                {["1-month free trial", "Mobile app on Play Store", "Web & admin dashboard"].map((t) => (
                  <li
                    key={t}
              ...
              <p className="mt-5 text-xs sm:text-sm text-gray-500 dark:text-gray-500 max-w-lg">
                Used by Rankraze and selected client teams. Mobile app access available on Play Store.
              </p>
            </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 -mt-16 md:-mt-20 mb-6">
          <nav
            aria-label="LMS Software page sections"
        ...
        <div className="relative z-5 border-t border-gray-100 dark:border-gray-800 bg-white/60 dark:bg-[#0B0E11]/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8">
            <p className="text-center text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-6">
              Trusted organizations &amp; marketing teams Rankraze works with
            </p>
